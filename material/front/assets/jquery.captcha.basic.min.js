! function(t) {
    ...
    t.fn.captcha = function(a) {
        ...
        i.attr("disabled", "disabled"), t('<label id="' + e.idCaptchaText + '"></label>').insertBefore(i), t('<input id="' + e.idCaptchaInput + '" aria-label="Captcha Input" type="text" class="form-control" oninput="myFunction(3)" required>').insertBefore(i);
