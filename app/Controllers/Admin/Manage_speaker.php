...
use DB;
class Manage_speaker extends BaseController {
    ...
    public function add()
    {
        ...
        if($this->request->getMethod() == 'post') {            
            ...
            $fieldName = 'image';
            if($originalName!='') {
                $upload_array = $this->common_model->upload_single_file($fieldName,$originalName,'speakers','image');
    ...
    public function edit($id)
    {
        ...
        if($this->request->getMethod() == 'post') {            
            ...
            if($originalName!='') {
                ...
                // if($data['row']->image!='') {
                //     unlink('uploads/speakers/'.$data['row']->image);  
                // }                
