...
class Manage_event_zones extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            ...
            'session'       => $session,
            'module'        => 'Event Zone',
            'controller'    => 'manage_event_zones',
            'table_name'    => 'event_zones',
            'primary_key'   => 'id'
        );
    }
