        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php } ?>                        
                    <h5>
                        <a target="_blank" href="<?php echo base_url(); ?>/admin/<?php echo $moduleDetail['controller']; ?>/download_csv" class="btn btn-success"><i class="fa fa-file-excel"></i> Download CSV</a>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name<br>Company Name<br>Designation</th>
                                    <th>Mobile</th>
                                    <th>Email</th>
                                    <!-- <th>Profile Image</th> -->
                                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo $row->name.' '.$row->lname; ?><br><?php echo $row->company_name; ?><br><?php echo $row->designation; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php } ?>
                                        <br><br>
                                        <a href="<?=base_url('admin/manage_user/booking_list/'.$row->$primary_key)?>" target="_blank" class="btn btn-primary"><i class="fa fa-list"></i> Booking List</a>
                                        <!-- <br><br>
                                        <a href="<?=base_url('admin/manage_user/wishlist/'.$row->$primary_key)?>" target="_blank" class="btn btn-info"><i class="fa fa-heart"></i> Wish  List</a> -->
                                    </td>
                                </tr>                                    
                                <?php } } ?>
                            </tbody>
