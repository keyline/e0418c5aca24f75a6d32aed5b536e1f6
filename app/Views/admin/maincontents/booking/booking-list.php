        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php } ?>
                    <h5>
                        <a target="_blank" href="<?php echo base_url(); ?>/admin/manage_booking/download_csv" class="btn btn-success"><i class="fa fa-file-excel"></i> Download CSV</a>
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $user = $moduleDetail['model']->find_data('sms_users', 'row', ['id' => $row->user_id]);
                                        if($user){
                                        ?>
                                        <i class="fa fa-user"></i> <?=$user->name.' '.$user->lname?><br>
