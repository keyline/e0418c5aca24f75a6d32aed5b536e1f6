                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row->advertisment_image!='') { ?>
                                          <img src="<?=base_url('/uploads/banners/'.$row->advertisment_image)?>" class="img-responsive img-thumbnail" style="max-height:100px; max-width:200px;"  />
                                        <?php } ?>                                        
                                    </td>
