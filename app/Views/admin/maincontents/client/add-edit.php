                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single form-control" id="partner_type" name="client_type">
                                        ...
                                        <!-- <option value="INSTITUTIONS"<?php if($client_type=='INSTITUTIONS') { ?> selected="selected"<?php } ?>>INSTITUTIONS</option> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">                                            
                                            <input type="file" class="custom-file-input" id="client_logo" name="client_logo"  accept="image/jpeg,image/gif,image/png">
