                        ...
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row->image!='') { ?>
                                          <img src="<?=base_url('/uploads/speakers/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;border-radius: 50%;"  />
                                        <?php } ?>
                                        <br>
                                        <?php echo $row->name; ?>                                        
                                    </td>
                                    <td><?php echo wordwrap($row->designation,40,"<br>\n"); ?></td>
                                    <td><?php echo wordwrap($row->company_name,40,"<br>\n"); ?></td>
