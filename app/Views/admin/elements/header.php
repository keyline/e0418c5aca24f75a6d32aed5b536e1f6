<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-green">
    <div class="m-header">
                ...
                <a href="<?=base_url('Dashboard')?>" class="b-brand">
                    ...
                    <!-- <img src="<?php echo base_url(); ?>/uploads/<?php echo $site_setting->site_logo; ?>" alt="<?php echo $site_setting->site_name; ?>" class="logo-thumb"> -->
            ...
            <li>
                <div class="dropdown drp-user">
                    <a href="#!" class="dropdown-toggle" data-toggle="dropdown">
                        <!-- <img src="<?php echo base_url(); ?>/uploads/<?php echo $site_setting->site_logo; ?>" class="img-radius wid-40" alt="<?php echo $site_setting->site_name; ?>"> -->
                        <img src="<?php echo base_url(); ?>/uploads/no-user-image.jpg" class="img-radius wid-40" alt="<?php echo $site_setting->site_name; ?>">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            <li><a href="<?php echo base_url('admin/user/site_setting'); ?>" class="dropdown-item"><i class="feather icon-user"></i> Site Setting</a></li>
