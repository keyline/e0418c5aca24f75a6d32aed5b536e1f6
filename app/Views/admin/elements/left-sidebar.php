<div class="navbar-wrapper">
    <div class="navbar-content scroll-div " >
        <ul class="nav pcoded-inner-navbar ">                    
            ...
            <li class="nav-item"><a href="<?php echo base_url('admin/manage_user/'); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-arrow-right"></i></span><span class="pcoded-mtext">Users</span></a></li>
            ...
            <li class="nav-item pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    <li><a href="<?= base_url('admin/manage_quize_title/') ?>">Quize Category</a></li>
